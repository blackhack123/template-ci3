...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg"><b>REGISTRO DE COMERCIANTES</b></p>

    <form action="#" method="post" autocomplete="off">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Cedula ó RUC" maxlength="13" id="cedula" name="cedula">
      ...
      <div class="form-group has-feedback">
        ...
        <span class="fa  fa-user fa-phone fa-lg form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
